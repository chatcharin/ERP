...
<fo:table-row>
  <fo:table-cell>
     <fo:block number-columns-spanned="2" font-weight="bold" font-family="Angsana New" >${invoice.getRelatedOne("InvoiceType").get("description",locale)}</fo:block>
  </fo:table-cell>
</fo:table-row>

<fo:table-row>
  <fo:table-cell><fo:block font-family="Angsana New" >${uiLabelMap.AccountingInvoiceDateAbbr}:</fo:block></fo:table-cell>
  <fo:table-cell><fo:block font-family="Angsana New" >${invoiceDate?if_exists}</fo:block></fo:table-cell>
</fo:table-row>
