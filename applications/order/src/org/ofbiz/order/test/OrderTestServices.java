...
public class OrderTestServices {
    ...
    public static Map testAdd(DispatchContext dctx, Map context) {
        LocalDispatcher dispatcher = dctx.getDispatcher();
        String salChanel = (String) context.get("salesChannel");
        try {
        	   new SalesOrderTest(salChanel).testCreateSalesOrder();
        	   Debug.logError(e, "Complete =====================================================================", module);
		} catch (Exception e) {
